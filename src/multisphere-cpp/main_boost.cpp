...
int main() {
    ...
    const int nx = 640, ny = 640, nz = 640;
    const float v_size = 1.0f;
    const float R_large = 200.0f;
    const float R_small = 70.0f;
    const Eigen::Vector3f center_large(R_large+10, 320.0f, 320.0f);
    ...
    int step_count = 0;
    float dist = 170.0;
    std::cout << "Step " << step_count << " (Dist: " << dist << ") processing." << std::endl;
